...
- **`references/graphify-camp-guide.md`** — **required** [Graphify](https://github.com/Graphify-Labs/graphify): query `graphify-out/` to find skills/docs before grepping; skill `graphify` + `AGENTS.md` + `scripts/setup-graphify.sh`
